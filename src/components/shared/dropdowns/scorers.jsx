...
const ScorersDropdown = ({ league }) => {
  ...
  return (
    <div className="relative">
      <div className="flex bg-white justify-between text-sm lg:text-base leading-5 py-4 xl:my-0 xl:mb-4 my-4 px-2 font-medium text-gray-700 items-center shadow-sm">
