...
const FixturesDropdown = ({ league }) => {
  const [show, setShow] = useState(false);

  return (
    <div className="relative">
      <div className="flex bg-blue-900 justify-between text-sm leading-5 p-2 border font-medium text-white items-center rounded-md shadow-sm">
        <div className="w-2/3">{league} Fixtures</div>
        <div
...
export default FixturesDropdown;
